...
def fetch_and_process_playlist():
    playlist_url = "https://www.youtube.com/watch?v=YzGFwnk1OWA&list=PLv_xoi4FGsu9_nEM3uIRO82C8_dKhqULw"
    playlist_name = "Bagaimana_Rasulullah_SAW_Mendidik_Generasi_Idaman"
    
    # Directory to save files
    directory = f"ustaz/halim/bagaimana_rasulullah_saw_mendidik_generasi_idaman"
