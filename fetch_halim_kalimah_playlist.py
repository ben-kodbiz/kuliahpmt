...
def fetch_and_process_playlist():
    playlist_url = "https://www.youtube.com/watch?v=cX-9058kQyg&list=PLv_xoi4FGsu-21LcpincGVo_XjyA38EmS"
    playlist_name = "Hakikat_Dua_Kalimah_Syahadah"
    
    # Directory to save files
    directory = f"ustaz/halim/hakikat_dua_kalimah_syahadah"
