#!/usr/bin/env python3
"""
Tool to fetch video IDs from Qarni's authentic YouTube playlists.
"""
...
def fetch_qarni_playlist_videos():
    """Fetch videos from Qarni's authentic playlists."""
    ...
    # Qarni's authentic playlists only
    playlists = [
        {
        ...
        {
            'name': 'penawar_penyakit_hati',
            'title': 'Penawar Penyakit Hati',
        ...
        {
            'name': 'manhaj_aqidah',
            'title': 'Manhaj Aqidah Imam Syafie',
        ...
        {
            'name': '72_kisah_hujah',
            'title': '72 Kisah Yang Tidak Boleh Dijadikan Hujah',
        ...
        {
            'name': 'ibn_abi_jamrah',
            'title': 'Kitab Mukhtasar Ibn Abi Jamrah',
        ...
        {
            'name': '1000_amalan_alt',
            'title': '1000 Amalan Sunnah (Alt)',
    ...
    for playlist in playlists:
        ...
        ydl_opts = {
            ...
            'quiet': False,
            'skip_download': True,
            'playlist_end': 32,  # Limit to reasonable number of videos
        }
...
def main():
    """Main function."""
    print("Fetching Ustaz Qarni's authentic YouTube playlist videos...")
    print("=" * 60)
    
    try:
        data = fetch_qarni_playlist_videos()
        print("\n" + "=" * 60)
        print("SUCCESSFULLY FETCHED QARNI'S VIDEOS!")
        print("=" * 60)
        print("Directories created:")
        print("- ustaz/qarni/1000_amalan_sunnah/")
        print("- ustaz/qarni/bacaan_pelik_ganjil/")
        print("- ustaz/qarni/30_teknik_tadabbur/")
