...
def fetch_and_process_playlist():
    playlist_url = "https://www.youtube.com/watch?v=012aSpqcF8o&list=PLv_xoi4FGsu8RZ2GjuMkOyw1-KGI9kteA"
    playlist_name = "Daurah_Pembahagian_Faraid"
    
    # Directory to save files
    directory = f"ustaz/adli/daurah_pembahagian_faraid"
