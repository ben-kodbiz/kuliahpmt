...
def create_html_embed_page(videos, playlist_name, output_dir):
    ...
    total_duration_seconds = sum(video.get('duration') or 0 for video in videos)
...
<head>
    ...
    <title>{playlist_name} - Ustaz Adli</title>
    <style>
        :root {{
...
<body>
    <div class="container">
        <div class="header">
            <h1>{playlist_name}</h1>
            <p>A collection of teachings by Ustaz Adli</p>
            <div class="stats">
                <div class="stat">
...
def fetch_and_process_playlist():
    playlist_url = "https://www.youtube.com/watch?v=7MeUXepEy1Y&list=PLv_xoi4FGsu-qQbyvUyp261mpoZXlqdk0"
    playlist_name = "Belajar_Bahasa_Arab"
    
    # Directory to save files
    directory = f"ustaz/adli/belajar_bahasa_arab"
